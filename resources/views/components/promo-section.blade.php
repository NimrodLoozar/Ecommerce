    ...
    <div class="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
        <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            <div class="sm:max-w-lg">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Find Your Perfect Drive
                </h1>
                <p class="mt-4 text-xl text-gray-500">Discover quality new and used cars from top brands. Whether you're
                    looking to buy or lease, we have the perfect vehicle waiting for you.</p>
            </div>
            <div>
                <div class="mt-10">
                    ...
                    <a href="#"
                        class="inline-block rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700">Browse
                        Inventory</a>
                </div>
            </div>
        </div>
