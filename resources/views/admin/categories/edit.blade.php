                    ...
                    <form action="{{ route('admin.categories.update', $category) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            @error('slug')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-sm text-gray-500">If left empty, will be auto-generated from the category name.</p>
                        </div>
                                ...
                                <div class="flex">
                                    ...
                                    <div>
                                        <p class="text-sm text-blue-700">
                                            This category has <strong>{{ $category->cars()->count() }}</strong> 
                                            {{ Str::plural('car', $category->cars()->count()) }} associated with it.
