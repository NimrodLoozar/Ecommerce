                    ...
                    <form action="{{ route('admin.features.update', $feature) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="4"
                                ...
                                placeholder="Brief description of this feature (optional)">{{ old('description', $feature->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-sm text-gray-500">Optional: Add details about what this feature includes</p>
                        </div>
                                ...
                                <div class="flex">
                                    ...
                                    <div>
                                        <p class="text-sm text-blue-700">
                                            This feature is used by <strong>{{ $feature->cars()->count() }}</strong> 
                                            {{ Str::plural('car', $feature->cars()->count()) }}.
