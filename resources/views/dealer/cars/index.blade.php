        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="mt-1 text-3xl font-semibold text-gray-900">{{ $cars->total() }}</div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="text-sm font-medium text-gray-500">Sold</div>
                    <div class="mt-1 text-3xl font-semibold text-purple-600">
                        {{ $cars->where('status', 'sold')->count() }}
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="text-sm font-medium text-gray-500">Reserved</div>
                    <div class="mt-1 text-3xl font-semibold text-yellow-600">
                        {{ $cars->where('status', 'reserved')->count() }}
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 h-16 w-20">
                                                        ...
                                                        @else
                                                            <div
                                                                class="h-16 w-20 rounded bg-gray-200 flex items-center justify-center">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                @if ($car->lease_price_monthly)
                                                    <div class="text-xs text-gray-500">
                                                        or €{{ number_format($car->lease_price_monthly, 2) }}/mo
                                                    </div>
                                                @endif
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span
                                                    ...
                                                    @elseif($car->status === 'sold') bg-purple-100 text-purple-800
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex items-center justify-end space-x-3">
                                                    ...
                                                    <form action="{{ route('dealer.cars.destroy', $car) }}"
                    ...
                    @else
                        ...
                        <div class="text-center py-12">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">No cars in inventory</h3>
